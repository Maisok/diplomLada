...
<body class="antialiased">
    ...
    <section class="relative h-[300px] md:h-[400px] flex items-center justify-center">
        ...
        <img src="{{asset('img/6.png')}}" alt="Фон нового пароля" class="absolute top-0 left-0 w-full h-full object-cover">
        <div class="relative z-20 text-center">
            <h1 class="text-3xl md:text-4xl font-bold text-white mb-4">Установка нового пароля</h1>
        </div>
    </section>
    ...
    <section class="py-16 px-4">
        <div class="max-w-md mx-auto">
            <div class="form-container bg-white p-8 md:p-12">
                <h2 class="text-2xl font-bold mb-8 text-center">Введите новый пароль</h2>
                ...
                <form action="{{ route('password.update') }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium mb-2" for="password">Новый пароль</label>
