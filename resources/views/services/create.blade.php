...
<head>
    ...
    <title>BB | Добавить услугу</title>
...
<body class="antialiased">
    ...
    <main>
        <div class="form-container">
            <h1 style="font-family: 'Playfair Display', serif; color: #333; text-align: center; margin-bottom: 2rem;">Добавить услугу</h1>
            
            <form action="{{ route('admin.services.store') }}" method="POST" enctype="multipart/form-data" onsubmit="return validateForm()">
                @csrf
                
                <div>
                    <label class="form-label" for="name">Название</label>
                    <input type="text" id="name" name="name" placeholder="Название услуги" maxlength="30" class="form-input">
                    @error('name')<p class="error-text">{{ $message }}</p>@enderror
                </div>
                
                <div>
                    <label class="form-label" for="price">Цена</label>
                    <input type="text" id="price" name="price" placeholder="Стоимость услуги" class="form-input">
